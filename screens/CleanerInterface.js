...
const CleanerInterface = () => {
  ...
  const functions = getFunctions(); // initialise Firebase Functions
  ...
  // 6) Mark clean (with optional afterPhoto upload + email)
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              // SEND EMAIL via Firebase Callable Function
              const sendCleanEmail = httpsCallable(functions, 'sendCleanNotification');
              await sendCleanEmail({
                email: selectedReport.email,
                reportId: selectedReport._id,
                location: `${selectedReport.town || ''}${
                  selectedReport.county ? ', ' + selectedReport.county : ''
                }`,
              });

              Alert.alert('Success', 'Report marked as clean and email sent.');
              handleCloseModal();
            } catch (err) {
            ...
            <ScrollView contentContainerStyle={styles.modalScrollView}>
              ...
              {canAttemptMap && REACT_APP_GOOGLE_MAPS_API_KEY ? (
                <View style={styles.modalMapContainer}>
                  {/* You can embed a larger MapView here if desired */}
                </View>
              ) : (
                <Text style={styles.modalDetailRow}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filterBar}>
        {/* Filter buttons for all_pending, high, medium, low, clean */}
        {/* ...same as before */}
      </View>
      ...
      <View style={styles.contentArea}>
        {loading ? (
          ...
          <View style={styles.errorContainer}>
            ...
            <TouchableOpacity style={styles.retryButton} onPress={fetchAllReportsForCleaner}>
